...
let modulePaths = {
 ...
 "packages/vtop/UI/Drawerlayout": "packages/vtop/UI/Drawerlayout.ddc",
 "packages/vtop/UI/homePage": "packages/vtop/UI/homePage.ddc",
 "packages/vtop/main": "packages/vtop/main.ddc",
 "packages/vtop/main_web_entrypoint": "packages/vtop/main_web_entrypoint.ddc"
};
...
define("main_web_entrypoint.dart.bootstrap", ["packages/vtop/main_web_entrypoint", "dart_sdk"], function(app, dart_sdk) {
  ...
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        ...
        if (childName === "package:vtop/main_web_entrypoint.dart") {
          // Clear static caches.
